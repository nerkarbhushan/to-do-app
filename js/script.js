...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function getUserPreferences() {
    ...
    const defaultPreferences = {
      name: "Bhushan Nerkar",
      email: "nerkarbhushan.b@gmail.com",
    };
  ...
  function promptForNameAndEmail() {
    swal({
      ...
      if (result && result.dismiss !== "cancel") {
        ...
        const finalName = name || "Mr Bhushan Nerkar ";
        const finalEmail = email || "nerkarbhushan.b@gmail.com";
  ...
  if (
    preferences.name === "Bhushan Nerkar" &&
    preferences.email === "nerkarbhushan.b@gmail.com"
  ) {
